...
import hoods.com.jetai.navigation.AiNavGraph
import hoods.com.jetai.navigation.AiNavigationActions
...
class MainActivity : ComponentActivity() {
    ...
    fun JetAiApp() {
        ...
        val navAction = remember {
            AiNavigationActions(navController)
        }

        val loginViewModel: LoginViewModel = viewModel()
        val authState by remember {
            mutableStateOf(loginViewModel.hasUserVerified())
        }
        ...
        Scaffold(bottomBar = {
            ...
            topBar = {
                AnimatedVisibility(isHomeDestination) {
                    TopAppBar(title = { Text(text = "Gemini AI") },
                        actions = {
                            IconButton(onClick = {
